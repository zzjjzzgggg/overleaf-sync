# Overleaf CE and Overleaf Syncing United
...
Options:
  ...
  -n, --name TEXT      Specify the project name, default to use current folder name as project name.
...
Options:
  -s, --server_ip IP  Server IP for Overleaf CE. If not provided, default to overleaf.com.
